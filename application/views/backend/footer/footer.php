...
<script type="text/javascript" src="<?php echo base_url();?>bower_components/jquery-form/dist/jquery.form.min.js"></script>
...
<script type="text/javascript" src="<?php echo base_url();?>bower_components/jquery-ui/jquery-ui.min.js"></script>
         ...
         <script type="text/javascript" src="<?php echo base_url();?>bower_components/datatables/media/js/dataTables.bootstrap4.min.js"></script>
         ...
         <script type="text/javascript" src="<?php echo base_url();?>bower_components/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js"></script>
